                ...
                <Card className="border-amber-500/30 bg-amber-50/50 dark:bg-amber-950/10">
                    <CardContent className="p-4">
                        <p className="text-sm text-amber-800 dark:text-amber-300">
                            ⚠️ This order includes rebranding work. Rebranding costs will be added
                            to your final quote. Additional services or vehicle requirements may
                    ...
                    <ol className="space-y-3 text-sm">
                        <li className="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-muted-foreground">
                                    Our logistics team will review your order and add any necessary
                                    services.
                                </p>
                            </div>
                        </li>
                        <li className="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-muted-foreground">
                                    We'll prepare a detailed quote including any additional services
                                    or rebranding costs.
                                </p>
                            </div>
                        </li>
                        <li className="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-muted-foreground">
                                    You'll receive the quote via email. Please review and respond
                                    within 48 hours.
                                </p>
                            </div>
                        </li>
