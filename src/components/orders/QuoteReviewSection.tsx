    ...
    <div className="space-y-6">
        ...
        <Card className="border-blue-500/30 bg-blue-50/50 dark:bg-blue-950/10">
          <CardContent className="p-4">
            <p className="text-sm text-blue-800 dark:text-blue-300">
              ℹ️ This order includes custom rebranding work which will be completed before delivery.
              Your order will enter fabrication once you approve this quote.
            </p>
          </CardContent>
        </Card>
      )}
        ...
        <DialogContent>
          ...
          <div className="space-y-4">
            <p className="text-sm">
              ...
              <span className="font-bold font-mono text-lg">{pricing.final_total.toFixed(2)} AED</span>
            </p>
            {hasReskinRequests && (
              <div className="bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-900 rounded-md p-3">
                <p className="text-sm text-blue-800 dark:text-blue-300">
                  Your order will enter fabrication for custom rebranding work before delivery.
                </p>
              </div>
            )}
      ...
      <Dialog open={declineDialogOpen} onOpenChange={setDeclineDialogOpen}>
        <DialogContent>
          ...
          <div className="space-y-4">
            <p className="text-sm text-muted-foreground">
              Please let us know why you're declining this quote so we can better assist you.
            </p>
            <div>
              <Label>Decline Reason <span className="text-destructive">*</span></Label>
              <Textarea
                value={declineReason}
          ...
          <DialogFooter>
            <Button variant="outline" onClick={() => setDeclineDialogOpen(false)} disabled={isDeclining}>
              Cancel
            </Button>
            <Button onClick={handleDecline} variant="destructive" disabled={isDeclining}>
