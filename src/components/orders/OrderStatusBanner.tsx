    ...
    return (
      <Alert className="border-blue-500 bg-blue-50 dark:bg-blue-950/20">
        ...
        <AlertDescription className="text-blue-800 dark:text-blue-200">
          Your order is confirmed and being prepared. Custom rebranding work is currently in progress.
          {pendingReskinCount > 0 && (
            <span className="block mt-2 font-semibold">
              {pendingReskinCount} rebrand{pendingReskinCount > 1 ? 's' : ''} in fabrication
            </span>
          )}
        </AlertDescription>
      </Alert>
