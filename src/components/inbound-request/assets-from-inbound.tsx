            ...
            <div className="grid grid-cols-1 gap-2">
                {items.map((item, index) => {
                    ...
                    return (
                        ...
                        >
                            <Card className="h-full hover:bg-muted/50 transition-colors border-border/50 overflow-hidden group">
                                    ...
                                    <div className="p-3 sm:p-4 flex flex-col justify-between flex-1 min-w-0">
                                        <div>
                                            <div className="flex items-start justify-between gap-2 mb-1">
                                                <h3 className="font-semibold text-sm sm:text-base truncate pr-2 group-hover:text-primary transition-colors">
                                                    {item.asset.name}
                                                </h3>
                                                <Badge
                                                    variant="secondary"
