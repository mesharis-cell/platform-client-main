...
export function AddWithRebrandButton({ asset, companyBrands, onAddToCart }: AddWithRebrandButtonProps) {
          ...
          <div className="space-y-4">
            ...
            <div className="bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-900 rounded-md p-3">
              <p className="text-xs text-blue-800 dark:text-blue-300">
                ℹ️ Rebranding costs will be quoted during order review. Final price may be higher than the standard estimate.
              </p>
            </div>
          </div>
