    ...
    <div className="space-y-4">
            ...
            <Label htmlFor="one-way" className="flex-1 cursor-pointer">
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Items will be delivered to your venue. You arrange return pickup.
                </p>
              </div>
            </Label>
          </div>
      ...
      <div>
        ...
        <p className="text-xs text-muted-foreground mt-2">
          Vehicle type is set to standard by default. Final vehicle requirements will be determined
          during order review and may affect pricing.
        </p>
      </div>
    </div>
  )
