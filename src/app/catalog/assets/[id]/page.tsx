        ...
        <div className="max-w-7xl mx-auto px-8 py-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
            ...
            <div className="space-y-6">
              ...
              {/* Availability */}
              <Card className={`p-6 ${asset.availableQuantity > 0 ? 'bg-primary/5 border-primary/20' : 'bg-destructive/5 border-destructive/20'}`}>
                    ...
                    <>
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground font-mono">
                          {asset.availableQuantity} of {asset.totalQuantity} available
                        </p>
                      </div>
                    </>
                  ) : (
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <Card className="p-4 bg-muted/30 border-border/50">
                    ...
                    <p className="text-2xl font-bold font-mono">{asset.volume} m³</p>
                  </Card>
                  <Card className="p-4 bg-muted/30 border-border/50">
                    <p className="text-xs font-mono text-muted-foreground uppercase tracking-wide mb-1">
                      Weight
                    </p>
                    <p className="text-2xl font-bold font-mono">{asset.weight} kg</p>
                  </Card>
                  <Card className="p-4 bg-muted/30 border-border/50">
                    <p className="text-xs font-mono text-muted-foreground uppercase tracking-wide mb-1">
                      Dimensions
                    ...
                    <p className="text-sm font-mono font-bold">
                      {asset.dimensionLength} × {asset.dimensionWidth} × {asset.dimensionHeight} cm
                    </p>
                  </Card>
                  <Card className="p-4 bg-muted/30 border-border/50">
                    <p className="text-xs font-mono text-muted-foreground uppercase tracking-wide mb-1">
                  ...
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <div className="flex items-center border border-border rounded-lg overflow-hidden">
                      ...
                      <Button
                        ...
                        onClick={() =>
                          setSelectedQuantity(
                            Math.min(asset.availableQuantity, selectedQuantity + 1)
                          )
                        }
                        disabled={selectedQuantity >= asset.availableQuantity}
