...
import type { CatalogAssetItem, CatalogCollectionItem } from "@/types/collection";
                ...
                <div className="relative max-w-7xl mx-auto px-8 py-12">
                    <div className="max-w-3xl">
                        ...
                        >
                            ...
                            <span className="font-mono uppercase tracking-wide">Asset Catalog</span>
                        </motion.div>
                        ...
                        >
                            Build Your
                            <span className="block text-primary mt-1">Event Setup</span>
                        </motion.h1>
                        ...
                        >
                            Browse premium event assets from furniture to glassware. Select
                            individual pieces or complete collections.
                        </motion.p>
                ...
                {isLoading ? (
                    ...
                    <Card className="p-20 text-center bg-card/50 border-border/50">
                        ...
                        <p className="text-muted-foreground mb-8 max-w-md mx-auto">
                            Try adjusting your search or filters to discover available assets
                        </p>
                        {hasActiveFilters && (
                            ...
                            <div className="flex-1 overflow-y-auto py-6 space-y-6">
                                ...
                                {selectedItem.type === "asset" && (
                                    <div className="space-y-4">
                                            ...
                                            <div className="grid grid-cols-3 md:grid-cols-5 gap-3">
                                                ...
                                                <div className="bg-primary/10 rounded-lg p-4 border border-primary/20">
                                                    ...
                                                    <p className="text-xl font-bold font-mono text-primary">
                                                        {Number(selectedItem.weight).toFixed(1)}{" "}
                                                ...
                                                <div className="bg-secondary/10 rounded-lg p-4 border border-secondary/20">
                                                    ...
                                                    <p className="text-xl font-bold font-mono">
                                                        {Number(selectedItem.volume).toFixed(3)}{" "}
                                        ...
                                        {selectedItem.type === "asset" &&
                                            selectedItem.tracking_method === "BATCH" && (
                                                <div>
                                                    <h4 className="text-xs font-semibold mb-3 uppercase tracking-wide text-muted-foreground font-mono">
                                                            ...
                                                            (selectedItem.condition === "ORANGE" ||
                                                                ...
                                                                <div className="col-span-2 bg-amber-500/10 rounded-lg p-4 border border-amber-500/20">
                                                                    ...
                                                                    <p className="text-xs font-mono text-muted-foreground mt-2">
                                                                        This item requires
                                                                        refurbishment. Factor this
                                                                        time into your event
                                                                        planning.
                                                                    </p>
                                                                </div>
                                                            )}
                                ...
                                {selectedItem.type === "collection" && (
                                    <div>
                                        <h3 className="text-sm font-semibold mb-4 uppercase tracking-wide text-muted-foreground font-mono">
                                            Collection Contents ({selectedItem.itemCount} items)
                                        </h3>
                                        <CollectionItemsList collectionId={selectedItem.id} />
                                    </div>
                                )}
                            </div>
                                        ...
                                        {selectedItem.tracking_method === "BATCH" && (
                                            <div className="flex items-center gap-4">
                                                ...
                                                <span className="text-sm text-muted-foreground font-mono">
                                                    of {selectedItem.availableQuantity} available
                                                </span>
                                            </div>
                                        )}
