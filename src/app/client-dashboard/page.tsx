...
import { useClientDashboardSummary } from "@/hooks/use-client-orders";
                                    ...
                                    <CardContent className="pt-6">
                                        <div className="flex items-center justify-between">
                                            <div>
                                                ...
                                                <p className="text-3xl font-bold text-foreground mt-1 font-mono">
                                                    {summary?.summary?.pending_quotes || 0}
                                                </p>
                                                <p className="text-xs text-muted-foreground mt-1">
                                                    Awaiting approval
                                                </p>
                                    ...
                                    <CardContent className="pt-6">
                                        <div className="flex items-center justify-between">
                                            <div>
                                                ...
                                                <p className="text-3xl font-bold text-foreground mt-1 font-mono">
                                                    {summary?.summary?.awaiting_return || 0}
                                                </p>
                                                <p className="text-xs text-muted-foreground mt-1">
                                                    Post-event
                                                </p>
                                ...
                                {summaryLoading ? (
                                    ...
                                    <div className="p-12 text-center">
                                        ...
                                        <p className="text-sm text-muted-foreground/70 mt-1">
                                            Start by browsing the catalog and creating your first
                                            order
                                        </p>
                                        <Link href="/catalog">
